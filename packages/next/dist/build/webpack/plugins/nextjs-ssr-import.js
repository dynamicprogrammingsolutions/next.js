...
class NextJsSsrImportPlugin{apply(compiler){compiler.hooks.compilation.tap('NextJsSSRImport',compilation=>{compilation.mainTemplate.hooks.requireEnsure.tap('NextJsSSRImport',(code,chunk)=>{// If we're on a chunk without a name, skip it. It's likely a dynamic import
// that will be handled by Webpack, i.e. a WASM module.
// See https://github.com/vercel/next.js/issues/22581
if(!chunk.name){return;}// Update to load chunks from our custom chunks directory
